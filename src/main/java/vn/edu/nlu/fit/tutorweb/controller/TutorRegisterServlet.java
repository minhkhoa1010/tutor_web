...
public class TutorRegisterServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        // ==========================================
        // 🌟 BỔ SUNG: Lấy danh sách ID lịch dạy từ form (Ví dụ: ["1", "2", "5"])
        String[] schedulesArray = request.getParameterValues("schedules");
        // ==========================================

        // Cập nhật hàm gọi DAO: Truyền thêm tham số schedulesArray vào cuối cùng
        boolean success = dao.registerTutor(request, avatarUrl, degreeUrls, citizenUrls, hourlyRate, schedulesArray);
        ...
        System.out.println("schedules = " + (schedulesArray != null ? Arrays.toString(schedulesArray) : "null"));
